...
test.describe('Goethe C1 Preparations Blog Post', () => {
  test('should be accessible from the blog page', async ({ page }) => {
    ...
    const goethePostLink = page.locator('article.blog-post h2 a:has-text("Part II: Preparations")');
  ...
  test('should display the correct title', async ({ page }) => {
    ...
    await expect(title).toHaveText('Goethe-Zertifikat C1 — My Experience, Part II: Preparations');
  });
